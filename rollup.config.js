 ...
 * @Last Modified time: 2023-02-07 17:02:39
 */
...
const buildBaseConfig = { name: 'weio-router', exports: 'named' };
...
export default [
  buildConfig({
    ...
    output: [
      {
        format: 'cjs',
        file: resolve(`lib/weio-router.js`),
        ...buildBaseConfig,
      },
      {
        format: 'esm',
        file: resolve(`lib/weio-router.esm.js`),
        ...buildBaseConfig,
      }
    ]
  })
